...
import { S3Client, PutObjectCommand, DeleteObjectCommand, DeleteObjectsCommand, CreateMultipartUploadCommand, AbortMultipartUploadCommand, UploadPartCommand, CompleteMultipartUploadCommand, GetObjectCommand, HeadObjectCommand } from "@aws-sdk/client-s3";
...
export class S3Helper {
     ...
     * @description : Upload part initialization
     */
    public largeImageupload = async (fileUploadOptions: any) => {
        const that = this;
     ...
     * @developer : Prithwiraj Bhadra
     * @date : 18-08-2023
     * @description : Get Signed URL for Specific File in S3
     */
